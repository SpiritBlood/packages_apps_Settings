...
import com.android.settings.spirit.DisplayRotation;
...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    private static final String SPIRIT_CATEGORY = "category_spirit_options";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!isColorEnhancementSupported()) {
            spiritPrefs.removePreference(mColorEnhancement);
            mColorEnhancement = null;
        }

        if (!DisplayColor.isSupported()) {
            spiritPrefs.removePreference(findPreference(KEY_DISPLAY_COLOR));
        }
        if (!DisplayGamma.isSupported()) {
            spiritPrefs.removePreference(findPreference(KEY_DISPLAY_GAMMA));
        }
