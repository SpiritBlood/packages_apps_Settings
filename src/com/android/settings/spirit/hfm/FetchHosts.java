/*
 * Copyright (C) 2014 The SpiritRom Project
 *
...
package com.android.settings.spirit.hfm;

import java.io.IOException;

import com.android.settings.spirit.hfm.HfmHelpers;
...
public class FetchHosts {
    ...
    public static void fetch() throws IOException {
        ...
        cmd = cmd + " && cat /etc/hosts[0-9] /etc/hosts.alt > /etc/hosts.tmp" //Merge old & new hosts
                  ...
                  + " && sed -i '1i#SpiritRom\' /etc/hosts.tmp" // Add SpiritRom tag
